...
def saymenu():
    ...
    my_msg5 = 'When sharing please start with "I am " so we can more easily focus on your feelings: for example:\n '
    my_msg2 = '\n" I am very concerned about the mission." \n' 
    my_msg2a = ' " I am wondering that  will we arrive on Mars." \n' 
    my_msg3 = ' "I am concerned that we re running out of fuel"'
    my_msg4 = ' \n "I am wondereing if there problems with the H9000 software"'
    my_msg  =  my_msg5 +  my_msg2 + my_msg2a +   my_msg3  + my_msg4
